...
export function seedDemo(){
  ...
  const demo:DocumentRow={id:crypto.randomUUID(),doc_number:'ЭТрН-2026-118',doc_date:'2026-09-01',status:'ready',created_at:now,updated_at:now,data:{
    ...
    loadingDetails:{matchingShipper:'1',employeeFullName:'Сидорова Екатерина Сергеевна',employeePosition:'Сотрудник склада',employeeResponsibilities:'Передача груза водителю',partyInn:'',ownerType:'1',ownerInn:'7700000000'},
